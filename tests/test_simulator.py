...
class TestSimulator(unittest.TestCase):
    ...
    def test_simulation_multiple_requests_one_worker(self):
        requests = [
            Request("user1", 0.0, 2.0),
            Request("user2", 0.5, 1.0)
        ]
        # 期待される動作:
    ...
    def test_simulation_requests_arrive_later_one_worker(self):
        requests = [
            Request("user1", 1.0, 2.0),
            Request("user2", 1.5, 1.0)
        ]
        # 期待される動作:
    ...
    def test_simulation_two_workers_competing_tasks(self):
        requests = [
            Request("user1", 0.0, 3.0),
            Request("user2", 0.1, 1.0),
            Request("user3", 0.2, 2.0)
        ]
        # 期待される動作:
    ...
    def test_queue_full_rejection(self):
        requests = [
            Request("user1", 0.0, 1.0),
            Request("user2", 0.1, 1.0),
            Request("user3", 0.2, 1.0)
        ]
        # 期待:
