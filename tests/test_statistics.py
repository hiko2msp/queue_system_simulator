import unittest
import numpy as np
from src.statistics import calculate_queuing_times, calculate_percentiles, calculate_simulation_statistics
from src.data_model import Request

class TestStatistics(unittest.TestCase):
    def test_calculate_queuing_times(self):
        requests = [
            Request("u1", 0, 1, arrival_time_in_queue=0.0, start_processing_time_by_worker=0.0, finish_processing_time_by_worker=1.0), # Q time = 0
            Request("u2", 0, 1, arrival_time_in_queue=0.1, start_processing_time_by_worker=1.0, finish_processing_time_by_worker=2.0), # Q time = 0.9
            Request("u3", 0, 1, arrival_time_in_queue=0.2, start_processing_time_by_worker=0.2, finish_processing_time_by_worker=1.2), # Q time = 0
            Request("u4", 0, 1, arrival_time_in_queue=0.3, start_processing_time_by_worker=2.0, finish_processing_time_by_worker=3.0), # Q time = 1.7
            Request("u5", 0, 1, arrival_time_in_queue=0.4, start_processing_time_by_worker=0.0, finish_processing_time_by_worker=-1), # Rejected, start_processing_time_by_worker is dummy
        ]
        queuing_times = calculate_queuing_times(requests) # calculate_queuing_timesは完了リスト全体を受け取るが、内部でフィルタする
    ...
    def test_calculate_queuing_times_attributes_not_set(self):
        ...
        requests = [
            Request("u1", 0, 1, finish_processing_time_by_worker=1.0), # arrival_time_in_queue と start_processing_time_by_worker が 0.0
            Request("u2", 0, 1, arrival_time_in_queue=1.0, finish_processing_time_by_worker=2.0) # start_processing_time_by_worker が 0.0
        ]
    ...
    def test_calculate_queuing_times_empty(self):
        ...
        requests_all_rejected = [
            Request("u5", 0, 1, arrival_time_in_queue=0.4, start_processing_time_by_worker=0.0, finish_processing_time_by_worker=-1)
        ]
    ...
    def test_calculate_simulation_statistics(self):
        requests = [
            Request("u1", 0, 1, arrival_time_in_queue=0.0, start_processing_time_by_worker=0.0, finish_processing_time_by_worker=1.0),
            Request("u2", 0, 1, arrival_time_in_queue=0.1, start_processing_time_by_worker=1.0, finish_processing_time_by_worker=2.0),
            Request("u3", 0, 1, arrival_time_in_queue=0.2, start_processing_time_by_worker=0.2, finish_processing_time_by_worker=1.2),
            Request("u4", 0, 1, arrival_time_in_queue=0.3, start_processing_time_by_worker=2.0, finish_processing_time_by_worker=3.0),
            Request("u5", 0, 1, arrival_time_in_queue=0.4, start_processing_time_by_worker=0.0, finish_processing_time_by_worker=-1),
        ]
    ...
    def test_calculate_simulation_statistics_all_rejected(self):
        requests = [
            Request("u1", 0, 1, arrival_time_in_queue=0.0, start_processing_time_by_worker=0.0, finish_processing_time_by_worker=-1),
            Request("u2", 0, 1, arrival_time_in_queue=0.1, start_processing_time_by_worker=0.0, finish_processing_time_by_worker=-1),
        ]
        stats = calculate_simulation_statistics(requests)
    ...
    def test_calculate_simulation_statistics_one_processed_request(self):
        requests = [
            Request("u1", 0, 1, arrival_time_in_queue=0.0, start_processing_time_by_worker=0.1, finish_processing_time_by_worker=1.1), # Q time = 0.1
        ]
        stats = calculate_simulation_statistics(requests)
